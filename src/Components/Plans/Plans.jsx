...
export default function Plans() {
  return (
    <div className="my-20">
      <h2 className="md:text-5xl text-4xl text-center font-bold flex justify-center text-[#444444]">
            اختاري الباقة المناسبة ليكي

      </h2>
        <p className="text-center opacity-65 my-4 text-lg">   ابدئي مجاناً أو احصلي على محتوى متقدم وحصري مع الباقة المميزة</p>
